...
export default function Contact({ onNavigate: _onNavigate }: ContactProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.fullName || !formData.email) {
      setErrorMessage(
        "Please fill out your name and email address so we can get back to you.",
      );
      return;
    }
  ...
  const faqs = [
    {
      ...
      answer:
        "A friendly member of our Houston team will reach out to you within a few business hours. We will schedule a short, pressure-free chat to learn about your business and see how we can help.",
    },
    {
      id: "c-faq-2",
      question: "Is the initial consultation really free?",
      answer:
        "Yes, absolutely. Our initial chat, bookkeeping review, and flat-rate price estimates are completely free with zero obligation.",
    },
    {
      id: "c-faq-3",
      question: "Are my business files kept confidential?",
      answer:
        "Yes, 100%. We take client privacy very seriously. We keep all your records private, secure, and protected in our encrypted folders, and we never share your files with anyone.",
    },
  ];
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg leading-relaxed text-slate-200 max-w-2xl mx-auto">
              ...
              processes and show you how simple it can be to maintain accurate,
            ...
            <div className="lg:col-span-5 space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                  Have a quick question about our bookkeeping help or setup
                  process? Give us a call or send us an email—we are happy to
                  chat!
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="flex items-start space-x-4 bg-slate-50/50 p-6 rounded-2xl border border-slate-100">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      Serving growing local businesses nationwide
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 bg-slate-50/50 p-6 rounded-2xl border border-slate-100">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-slate-400 uppercase font-mono tracking-wider font-mono">
                      Business Hours
                    </h4>
              ...
              <div className="p-5 rounded-2xl border border-slate-200 bg-slate-50/80 flex items-center space-x-3.5">
                ...
                <span className="text-xs font-medium text-slate-600 leading-relaxed">
                  Your business files and banking read-only connections are kept
                  ...
                  {!isSubmitted ? (
                    ...
                    >
                      <div className="mb-8">
                        ...
                        <p className="text-xs text-slate-500 mt-1">
                          Fill out this simple form, and one of our friendly
                      ...
                      <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                          ...
                          <div>
                            <label
                              htmlFor="fullName"
                              className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2 font-mono"
                            >
                              Your Name{" "}
                    ...
                    >
                      ...
                      <p className="mt-3 text-sm text-slate-500 leading-relaxed max-w-md mx-auto">
                        ...
                        . We have received your request, and a friendly member
                        of our Houston team will get back to you at{" "}
                        <span className="font-semibold text-slate-800">
                          {formData.email}
                        </span>{" "}
