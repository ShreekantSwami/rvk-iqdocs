  ...
  const faqs = [
    {
      ...
      answer:
        "We can clean up and untangle bookkeeping records extending back multiple fiscal years. No backlog is too messy or too outdated for us to sort through.",
    },
    {
      id: "cu-faq-2",
      question: "Will I need to spend a lot of time on this?",
      answer:
        "No. Once you securely share view-only access to your bank statements and QuickBooks Online, we do the heavy lifting. We operate independently and will only reach out with a consolidated list if we have questions about specific mystery transactions.",
    },
    {
      id: "cu-faq-3",
      question: "How do you price books cleanup projects?",
      answer:
        "We price our cleanup projects using a straightforward, upfront flat-rate pricing system based on the number of months or years of backlog and the number of bank and credit card accounts involved. We never charge surprise hourly fees, so you will know the exact cost before we start any work.",
    },
  ];
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-relaxed text-slate-300 max-w-3xl">
              No matter how far behind your books may be, IQ-docs has the
              expertise to clean up complex accounts, resolve backlogs, and
              deliver accurate, organized records ready for a seamless CPA
              handoff.
            </p>
            <div className="mt-8">
              <button
                ...
                onClick={() => {
                  ...
                  if (el) {
                    const y =
                      el.getBoundingClientRect().top + window.scrollY - 30;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5 space-y-6">
              ...
              <p className="text-base text-slate-600">
                We perform a comprehensive, deep-cleaning protocol to make sure
                your financial ledger is perfectly dialed-in, verified, and
                transparent.
              </p>
            </div>
